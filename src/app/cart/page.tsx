    ...
    <div className="bg-gray-50 min-h-screen py-12 px-6">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-start gap-10 max-w-7xl mx-auto">
          ...
          {products.map((product) => (
            ...
            >
              ...
              <img
                src={product.image}
                alt={product.name}
                className="w-32 h-28 object-cover rounded-lg border border-gray-200"
              />
              ...
              <div className="flex flex-col flex-1 justify-between h-full">
                ...
                <div className="flex items-center gap-4 mt-2">
                  ...
                  <div className="flex items-center gap-4 border border-gray-300 px-3 py-1 rounded-lg w-fit shadow-sm">
                    <button className="text-xl font-bold text-gray-700 hover:text-lime-600">+</button>
                    <span className="text-base font-medium">1.00</span>
                    <button className="text-xl font-bold text-gray-700 hover:text-red-500">-</button>
                  </div>

                  {/* Unit Selector */}
                  <div className="relative w-[130px]">
                    <select className="appearance-none block w-full bg-white border border-gray-300 text-gray-700 py-2 px-3 pr-8 rounded-lg shadow-sm focus:ring-2 focus:ring-lime-500">
                      <option>Sack</option>
                      <option>Box</option>
                  ...
                  {/* Remove button */}
                  <button className="flex items-center justify-center bg-red-500 hover:bg-red-600 transition text-white px-4 py-2 rounded-lg shadow-md">
        ...
        <div className="w-full max-w-sm p-6 bg-white rounded-2xl shadow-md">
          ...
          <button className="w-full mt-8 bg-lime-500 hover:bg-lime-600 transition text-white px-6 py-3 rounded-xl font-semibold shadow-lg">
            Proceed to Payment
          </button>
        </div>
      </div>
