    ...
    <main className="min-h-screen flex items-center justify-center bg-white px-6 py-16">
      <div className="text-center w-[660px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          ...
          <div className="border rounded-2xl shadow-sm p-8 text-left hover:shadow-xl transition flex flex-col justify-between">
...
/>
              ...
              <p className="text-2xl font-bold mt-2">
                $59.99<span className="text-base font-normal">/mes</span>
              </p>
